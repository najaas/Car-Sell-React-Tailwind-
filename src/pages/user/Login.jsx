...
<LoginForm
    section={
      ...
      <form action="" className="flex flex-col gap-4">
        ...
        <Link to='/home' className="bg-[#002D74] text-white flex justify-center py-4 rounded-xl hover:scale-105 duration-300 hover:bg-[#206ab1] font-medium" type="submit">Login
        </Link>
      </form>
